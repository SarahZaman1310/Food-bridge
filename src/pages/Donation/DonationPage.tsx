  ...
  return (
    <div className="donation-page">
      <header className="donation-header">
        <Link className="brand" to="/" aria-label="FoodBridge home">
          <span className="brand-mark">
            <svg viewBox="0 0 24 24" aria-hidden="true" className="icon" width="23" height="23" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      ...
      <main className="donation-main">
        <section className="section-shell donation-hero" aria-labelledby="donation-title">
          <p className="kicker">SHARE FOOD. SUPPORT COMMUNITIES.</p>
          <h1 id="donation-title">Donate surplus food</h1>
          <p>
            Donors can share usable surplus food with verified charities and communities instead of letting it go to waste.
          </p>
        </section>
            ...
            <div className="form-card">
              <div className="form-grid">
                ...
                <div className="form-section">
                  ...
                  <div className="field-group">
                    <label htmlFor="expiryAt">Expiry / Best before</label>
                    <input
                      id="expiryAt"
                      name="expiryAt"
                      type="datetime-local"
                    ...
                    <small className="helper-text">
                      Please provide the estimated time until which the food remains safe to collect and consume.
                    </small>
                  </div>
                </div>
              </div>

              <div className="safety-box" aria-label="Donation safety information">
                <h3>Donation checklist</h3>
                <ul>
                  <li>Food should be safe and suitable for consumption.</li>
                  <li>Please provide accurate quantity and expiry information.</li>
                  <li>A verified organisation may contact the donor regarding collection.</li>
                </ul>
              </div>
              ...
              <div className="confirmation-row">
                ...
                <label htmlFor="confirmation">
                  I confirm that the food information provided is accurate and the food is suitable for donation.
                </label>
              </div>

              <div className="submit-row">
                <button className="button" type="submit" disabled={!isReady}>
                  Submit donation
                </button>
                {successMessage ? (
        ...
        <section className="section-shell donations-section" aria-labelledby="donations-title">
          <div className="donations-header">
            <div>
              <p className="kicker">Your donations</p>
              <h2 id="donations-title">Your Donations</h2>
            </div>
            <p>Manage the food donations you have added.</p>
          </div>

          {donations.length === 0 ? (
            <div className="empty-state" aria-live="polite">
              <h3>No donations added yet</h3>
              <p>Your submitted food donations will appear here.</p>
            </div>
          ) : (
              ...
              {donations.map((donation) => (
                <article className="donation-card" key={donation.id}>
                  ...
                  <dl className="card-details">
                    ...
                    <div>
                      <dt>Expires</dt>
                      <dd>{formatExpiry(donation.expiryAt)}</dd>
                    </div>
                    <div>
                      <dt>Donor</dt>
                  ...
                  <div className="card-footer">
                    <button type="button" className="delete-button" onClick={() => handleDelete(donation.id)}>
                      Delete
                    </button>
                  </div>
                </article>
